...
public class StudentServletTest {
    ...
    class doPostTests {
        ...
        @Test
        void doPostExistsJson() throws IOException, ServletException {
            StudentRepository repo = new StudentRepository();
            Assumptions.assumeTrue(repo.size() > 0);
        ...
        @Test
        void doPostCorruptedJson() throws IOException, ServletException {
            // Set the Content-Type header to application/json
            when(request.getHeader("Content-Type")).thenReturn("application/json");
        ...
        @Test
        void doPostJsonObjectAdding() throws IOException, ServletException {
            Assumptions.assumeFalse(new StudentRepository().takeData().contains(studentToAdd));
            ObjectMapper objectMapper = new ObjectMapper();
            // Set the Content-Type header to application/json
            when(request.getHeader("Content-Type")).thenReturn("application/json");
        ...
        private Student studentToAdd = new Student(-1, "added", 20, new Random().nextLong(), 1000);
    ...
    class doPutTests {
        ...
        void doPutNotFoundJson(Student studentToAdd) throws IOException, ServletException {
